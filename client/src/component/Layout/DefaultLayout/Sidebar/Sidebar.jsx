...
const Sidebar = () => {
  ...
  return (
    <nav class="w-56 bg-white shadow-lg h-screen fixed left-0  z-10 top-16">
      <div class="mt-16">
        <div className="text-gray-600 font-semibold text-sm uppercase px-4 font-TiltNeon w-full h-16 flex justify-center items-center">
          <button
            class="text-3xl flex items-center mr-5"
            onClick={() => SetTrendingVisible(!TrendingVisible)}
          >
            <div className="text-2xl mr-1 ">
              {TrendingVisible ? <AiOutlineRight /> : <AiOutlineDown />}
            </div>
            Trending
          </button>
        </div>
        {TrendingVisible ? null : (
          <ul class="py-4">
